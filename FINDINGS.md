...
## Development
Verify system prompt performance on a single user prompt
<p align="center">
...
Verify system prompt performance on multiple user prompts
<p align="center">
...
Compare performance between two system prompts
```bash
...
Traces stored in Cloud trace with a GCS reference for prompts and responses. Using a Bigquery view, the trace and GCS reference are combined together.
<p align="center">
  <img src="assets/images/trace-content.jpg" alt="Overview of traces" width="45%" />
</p>

ADK Bigquery analytics plugin has detailed information of each step the agent took
<p align="center">
